...
const TestimonialSection = () => {
  ...
  return (
    <div className='pb-14 px-8 md:px-0 max-sm:hidden'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-14 px-auto'>
          {
            testimonials.map((testimonial, idx) => (
              <div key={idx} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-sm shadow-black/5 overflow-hidden hover:scale-[101%] transition-all duration-300 hover:shadow-md'>
